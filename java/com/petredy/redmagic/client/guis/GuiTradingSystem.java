...
public class GuiTradingSystem extends GuiContainer{
	...
	public ContainerTradingChest container;
	...
	public GuiTradingSystem(EntityPlayer player, TileEntityTradingChest tileEntity) {
		super(new ContainerTradingChest(player,tileEntity));
	...
	public void handleMouseInput()
    {
        ...
        if (i != 0)
        {
            ...
            ((ContainerTradingChest)this.inventorySlots).scrollTo(this.currentScroll);
        }
