...
public class RenderSoulChest extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler{

	private ModelChest modelChest = new ModelChest();
	
	@Override
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
		if (tileEntity instanceof TileEntitySoulChest) {

			TileEntitySoulChest tile = (TileEntitySoulChest) tileEntity;
            ...
            Redmagic.proxy.bindTexture(Textures.SOUL_CHEST);
            GL11.glPushMatrix();
