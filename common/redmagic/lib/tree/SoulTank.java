...
public class SoulTank implements ILiquidTank{
    ...
    public SoulTank(int liquidId, int quantity, int capacity)
    {
        this(new LiquidStack(liquidId, quantity), capacity);
    }

    public SoulTank(int liquidId, int quantity, int capacity, TileEntity tile)
    {
        this(liquidId, quantity, capacity);
        this.tile = tile;
    }

    public SoulTank(LiquidStack liquid, int capacity)
    {
        this.liquid = liquid;
        this.capacity = capacity;
    }

    public SoulTank(LiquidStack liquid, int capacity, TileEntity tile)
    {
        ...
        if (liquid == null || liquid.itemID <= 0)
        {
            ...
            else
            {
                if (doFill)
                {
                    ...
                    if(capacity > 0)this.liquid.amount = capacity;
                    if (tile != null)
    ...
    public SoulTank readFromNBT(NBTTagCompound nbt)
    {
