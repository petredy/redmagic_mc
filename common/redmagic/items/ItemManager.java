...
public class ItemManager {
	...
	public static ItemSoulMachine machine;
	...
	public static ItemStatemeter statemeter;
	public static ItemWrench wrench;
	public static ItemCrystal crystal;
	
	public static void init(){
		redhole = new ItemRedhole(ItemIndex.REDHOLE_ID);
		machine = new ItemSoulMachine(ItemIndex.MACHINE_SOUL_ID);
		...
		statemeter = new ItemStatemeter(ItemIndex.STATEMETER_ID);
	...
	public static void config(Configuration config){
		...
		ItemIndex.MACHINE_SOUL_ID = config.getItem(ItemIndex.MACHINE_SOUL_NAME, ItemIndex.MACHINE_SOUL_DEFAULT_ID).getInt(ItemIndex.MACHINE_SOUL_DEFAULT_ID);
		...
		ItemIndex.STATEMETER_ID = config.getItem(ItemIndex.STATEMETER_NAME, ItemIndex.STATEMETER_DEFAULT_ID).getInt(ItemIndex.STATEMETER_DEFAULT_ID);
